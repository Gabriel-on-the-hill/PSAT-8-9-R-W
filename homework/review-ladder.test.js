...
// BEHIND `unseen` in the draw. The bank holds ~719 questions and a set takes six,
...
const LEDGER_KEY = 'psat89_progress_guest';   // 'psat89_progress_' + (sessionStorage psat89_user || 'guest')
const TRAP_KEY   = 'psat89_trap_stats_guest'; // per-skill accuracy — what calibration reads
