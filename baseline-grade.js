...
// ── projection ────────────────────────────────────────────────────
// The PSAT 8/9 R&W section score runs 120–720. (The sister SAT app projects
// 200–800 — do not copy its numbers.)
//
...
const BASELINE_SCALE_LOW  = 120;
const BASELINE_SCALE_HIGH = 720;
...
function projectBaseline(items) {
    ...
    // mapping Medium accuracy straight onto 120–720 would overstate a strong
